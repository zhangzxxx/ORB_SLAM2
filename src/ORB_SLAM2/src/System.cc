...
#include "System.h"
#include "Converter.h"      // ? 该库的作用？
#include <thread>               //  多线程
#include <pangolin/pangolin.h>      
#include <iomanip>  // 主要是对一些 cin, cout 之类的一些操作运算子

namespace ORB_SLAM2
{

// 系统的构造函数，将会启动其他线程
System::System(const string &strVocFile,                    // 字典文件路径
                ...
                mbDeactivateLocalizationMode(false)         // 没有这个模式转换标志
{
    ...
    //Check settings file
    cv::FileStorage fsSettings(strSettingsFile.c_str(),         // 将配置文件名转换成字符串
                               cv::FileStorage::READ);          // 只读模式
    ...
    // 这里的帧绘制器和地图绘制器将被会被可视化的Viewer所使用
    ...
    // 在主进程中初始化追踪线程
    mpTracker = new Tracking(this,                  // ? this指针作用
                             mpVocabulary,          // 字典
                             mpFrameDrawer,         // 帧绘制器
                             mpMapDrawer,           // 地图绘制器
                             mpMap,                 // 地图
